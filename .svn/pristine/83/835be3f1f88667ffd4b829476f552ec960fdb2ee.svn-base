                        ...
                        <tr class="info">
                            ...
                            <td class="tdLast">
                               <span  id="oper_<s:property value='oid'/>">
                               	   <s:if test="state==1">
                               		  <a class="btn" href="javascript:doPublic('<s:property value='oid'/>',0)">取消</a>
                               	   </s:if>
                               	   <s:else>
                               	      <a class="btn" href="javascript:doPublic('<s:property value='oid'/>',1)">确认</a>
                               	   </s:else>
                               	</span>
                                <input class="delete btn" type="button" value="删除" onclick="doDelete('<s:property value='oid'/>')">
                            </td>
                        </tr>
                        </tbody>
                    </table>
